export default function PrivacyPage() {
  return (
    <div className="container text-only-page">
      ...
      <h3>All-Inkl</h3>
      <p>
        The Provider is the ALL-INKL.COM &ndash; Neue Medien M&uuml;nnich, owner: Ren&eacute;
        M&uuml;nnich, Hauptstra&szlig;e 68, 02742 Friedersdorf, Germany (hereinafter
        &ldquo;All-Inkl&rdquo;). For details, please visit the privacy policy of All-Inkl:{' '}
        <a
      ...
      <p>
        The use of All-Inkl is based on Art. 6(1)(f) GDPR. We have a legitimate interest in the most
        reliable representation of our website. If appropriate consent has been obtained, the
        ...
        the user&rsquo;s end device (e.g., device fingerprinting) within the meaning of the TTDSG.
      ...
      <p>
        konzentrik GmbH
        <br />
        Joachim-M&auml;hl-Stra&szlig;e 7<br />
        22459 Hamburg
      </p>
      <p>
        Phone: +49 40 57003237
        <br />
        E-mail: info@konzentrik.de
      </p>
      <p>
      ...
      <p>
        ...
        device fingerprinting), the data processing is additionally based on &sect; 25 (1) TTDSG.
      ...
      <p>
        ...
        permitted if the recipient is certified under the &ldquo;EU-US Data Privacy Framework&rdquo;
        (DPF) or has appropriate additional assurances. Information on transfers to third-party
        countries, including the data recipients, can be found in this Privacy Policy.
      </p>
      ...
      <p>
        If you are under an obligation to share your payment information (e.g. account number if you
        give us the authority to debit your bank account) with us after you have entered into a
        fee-based contract with us, this information is required to process payments.
      </p>
      <p>
        Payment transactions using common modes of paying (Visa/MasterCard, debit to your bank
        account) are processed exclusively via encrypted SSL or TLS connections. You can recognize
        an encrypted connection by checking whether the address line of the browser switches from
        &ldquo;http://&rdquo; to &ldquo;https://&rdquo; and also by the appearance of the lock icon
        in the browser line.
      </p>
      <p>
      ...
      <p>
        ...
        6(1)(a) GDPR and &sect; 25 (1) TTDSG); this consent may be revoked at any time.
      </p>
      <p>
      ...
      <p>
        The processing of these data is based on Art. 6(1)(b) GDPR, if your request is related to
        the execution of a contract or if it is necessary to carry out pre-contractual measures. In
        all other cases the processing is based on our legitimate interest in the effective
        processing of the requests addressed to us (Art. 6(1)(f) GDPR) or on your agreement (Art.
      ...
      <p>
        ...
        to eradicate the data, revoke your consent to the archiving of data or if the purpose for
      ...
      <h3>Calendly</h3>
      <p>
        You can make appointments with us on our website. We use the &ldquo;Calendly&rdquo; tool for
        booking appointments. The provider is Calendly LLC, 271 17th St NW, 10th Floor, Atlanta,
        Georgia 30363, USA (hereinafter &ldquo;Calendly&rdquo;).
      </p>
      <p>
        ...
        Calendly, whose privacy policy can be viewed here:{' '}
      ...
      <p>
        ...
        justified interest in making appointments with interested parties and customers in as
        uncomplicated a manner as possible. If appropriate consent has been obtained, the processing
        is carried out exclusively on the basis of Art. 6(1)(a) GDPR and &sect; 25 (1) TTDSG,
        insofar the consent includes the storage of cookies or the access to information in the
        user&rsquo;s end device (e.g., device fingerprinting) within the meaning of the TTDSG. This
      ...
      <p>
        ...
        Limited (&ldquo;Google&rdquo;), Gordon House, Barrow Street, Dublin 4, Ireland.
      </p>
      <p>
        We use YouTube in the expanded data protection mode. According to YouTube, this mode ensures
        that YouTube does not store any information about visitors to this website before they watch
        the video. Nevertheless, this does not necessarily mean that the sharing of data with
        ...
        connection with the Google Marketing Network.
      </p>
      <p>
        As soon as you start to play a YouTube video on this website, a connection to
        YouTube&rsquo;s servers will be established. As a result, the YouTube server will be
        notified, which of our pages you have visited. If you are logged into your YouTube account
        while you visit our site, you enable YouTube to directly allocate your browsing patterns to
        your personal profile. You have the option to prevent this by logging out of your YouTube
        account.
      </p>
      <p>
        Furthermore, after you have started to play a video, YouTube will be able to place various
        cookies on your device or comparable technologies for recognition (e.g. device
        fingerprinting). In this way YouTube will be able to obtain information about this
        website&rsquo;s visitors. Among other things, this information will be used to generate
        video statistics with the aim of improving the user friendliness of the site and to prevent
      ...
      <p>
        ...
        manner. Pursuant to Art. 6(1)(f) GDPR, this is a legitimate interest. If appropriate consent
        has been obtained, the processing is carried out exclusively on the basis of Art. 6(1)(a)
        GDPR and &sect; 25 (1) TTDSG, insofar the consent includes the storage of cookies or the
        access to information in the user&rsquo;s end device (e.g., device fingerprinting) within
